...
SECRET_KEY = 'django-insecure-vh!!f)9lc2-+io6g^b8u_ujetsub$9(-snb89m4!c_rx-1-jp^'
...
TEMPLATES = [
    {
        ...
        'DIRS': ['ProyectoWeb/proyectoWebApp/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = 'static/' # Se debe crear una carpeta que se llame static en cada App.
